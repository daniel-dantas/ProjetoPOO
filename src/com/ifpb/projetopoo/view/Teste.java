...
//       teste.remove("211.111.111-11");
        ...
        */
        ...
        /*
        Paciente paciente = new Paciente("711.111.111-11", "Pessoa 2", LocalDate.now(), new Endereco("rua", "cidade", "bairro", "estado"), new Contato(null, "1111-1111"));
        paciente.addDescricao("Pressão alta");
        paciente.addDescricao("Enxaqueca");

        DAO pacienteDAO = new PacienteDAO();
